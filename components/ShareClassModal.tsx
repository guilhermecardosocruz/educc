          ...
          <div className="absolute inset-0 flex items-center justify-center p-4">
            <div className="w-full max-w-lg rounded-xl bg-white p-5 shadow-xl">
              ...
              <p className="text-sm text-gray-600 mb-3">
                Crie um link para convidar alguém como <strong>Professor</strong> (único)
                ou <strong>Gestor</strong> (vários).
              </p>
              ...
              {msg && <div className="mb-3 text-sm text-green-700 bg-green-50 border border-green-200 rounded-md p-2">{msg}</div>}
              {err && <div className="mb-3 text-sm text-red-700 bg-red-50 border border-red-200 rounded-md p-2">{err}</div>}
