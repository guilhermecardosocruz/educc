    ...
    <main className="min-h-screen p-6 lg:p-10">
      <div className="max-w-3xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-2xl font-semibold">Chamadas • {cls.name}</h1>
          <div className="flex gap-4">
            <Link href={`/classes/${cls.id}`} className="text-[var(--color-brand-blue)] hover:underline">Turma</Link>
            <Link href={`/classes/${cls.id}/conteudos`} className="text-[var(--color-brand-blue)] hover:underline">Conteúdos</Link>
        ...
        <div className="card p-6">
          <p className="text-gray-700">
            (Placeholder) Aqui você poderá registrar presenças, criar datas de chamada, exportar, etc.
          </p>
        </div>
      </div>
    </main>
